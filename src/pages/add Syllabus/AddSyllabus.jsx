...
const AddSyllabus = () => {
    ...
    const [sylldoc, setSylldoc] = useState('');
            ...
            <div className="newNoticeContainer">
                ...
                <div className="new-notice-page">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <label htmlFor="sylldoc">Upload Syllabus:</label>
                            <input
                                type="file"
                                id="sylldoc"
                                value={sylldoc}
                                onChange={(e) => setSylldoc(e.target.value)}

                            />
                        </div>
                        <button onClick={handleSubmit} type="submit">Add Syllabus</button>
                    </form>
                </div>
            </div>
        </div>
