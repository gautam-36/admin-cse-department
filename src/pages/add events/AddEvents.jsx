...
const AddEvents = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const publicationResponse = await axios.post('http://localhost:5000/api/alumni', newPublication);

            // Handle success response here
            console.log('New Notice:', publicationResponse.data);
                ...
                <div className="new-notice-page">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <label htmlFor="description">Title of Event:</label>
                            <input
                                type="text"
                                id="description"
                                value={description}
                        ...
                        <div className="form-group">
                            <label htmlFor="date">Upload Image or Poster of Events:</label>
                            <input
                                type="file"
                                id="facultyName"
                                value={date}
                        ...
                        <button onClick={handleSubmit} type="submit">Add News</button>
                    </form>
                </div>
            </div>
        </div>
