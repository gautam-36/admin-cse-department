...
const AddNews = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const noticeResponse = await axios.post('http://localhost:5000/api/alumni', newNotice);

            // Handle success response here
            console.log('New Notice:', noticeResponse.data);
                ...
                <div className="new-notice-page">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <label htmlFor="description">Title of News:</label>
                            <input
                                type="text"
                                id="description"
                                value={description}
